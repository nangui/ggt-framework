...
if (isset($_smarty_tpl->tpl_vars['get']->value['action']) && in_array($_smarty_tpl->tpl_vars['get']->value['action'],array('alertes','panier'))) {?>
    <div class="col-lg-4">
    ...
    <div class="col-lg-8">
        <h6 class="uppercase">Et faire apparaître <?php if (($_smarty_tpl->tpl_vars['get']->value['action'] == 'alertes')) {?> vos alertes enregistrées <?php } else { ?> votre sélection de biens <?php }?> !</h6>
