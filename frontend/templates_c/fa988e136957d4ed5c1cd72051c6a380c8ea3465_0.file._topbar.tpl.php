...
/logo/logo_carat_color.svg" alt="logo principal" title="Aller à l'accueil" class="logo_principal"></a>
            ...
            <div class="col-lg-10">
                <ul class="inline-menu list-inline list-unstyled">
                    <li class="<?php if ($_smarty_tpl->tpl_vars['get']->value['action'] == 'biens') {?>is-active<?php }?>"> <a href="<?php echo $_smarty_tpl->tpl_vars['get']->value['path'];?>
/liste-proprietes"> NOS BIENS </a> </li>
                    <li class="<?php if ($_smarty_tpl->tpl_vars['get']->value['action'] == 'vendeurs') {?>is-active<?php }?>"> <a href="<?php echo $_smarty_tpl->tpl_vars['get']->value['path'];?>
/vendre-votre-bien"> VENDEURS </a> </li>
                    <li class="<?php if ($_smarty_tpl->tpl_vars['get']->value['action'] == 'acheteurs') {?>is-active<?php }?>"> <a href="<?php echo $_smarty_tpl->tpl_vars['get']->value['path'];?>
/agent-de-recherche"> ACHETEURS </a> </li>
                    <li class="<?php if ($_smarty_tpl->tpl_vars['get']->value['action'] == 'savoirfaire') {?>is-active<?php }?>"> <a href="<?php echo $_smarty_tpl->tpl_vars['get']->value['path'];?>
/savoir-faire"> NOTRE SAVOIR-FAIRE </a> </li>
                    <li class="<?php if ($_smarty_tpl->tpl_vars['get']->value['action'] == 'index') {?>is-active<?php }?>"> <a href="<?php echo $_smarty_tpl->tpl_vars['get']->value['path'];?>
