...
<div class="pagelander-small py-4 pb-5" data-block-bg-is="blue">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-12">
                <?php $_smarty_tpl->_subTemplateRender(((string)$_smarty_tpl->tpl_vars['template']->value)."/common/_search_form.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0, true);
?>
            </div>
        </div>
    </div>
                ...
                <div class="h3 section_heading title-font--light">
                    <i>
                        <?php if (isset($_smarty_tpl->tpl_vars['carat']->value['simplesearchliens'])) {?>
                            ...
                            <?php if (isset($_smarty_tpl->tpl_vars['carat']->value['btitleh1page']['ville'])) {?><div class="text-primary title-font--bold uppercase"><?php echo $_smarty_tpl->tpl_vars['carat']->value['btitleh1page']['ville'];?>
</div><?php }?>
                        <?php } else { ?>
...
&tribiens&valeur=" + this.value, "", "oui", "");'>
                            ...
                            <option value="1" <?php if ((($_SESSION[$_smarty_tpl->tpl_vars['get']->value['app']][($_smarty_tpl->tpl_vars['get']->value['module']).($_smarty_tpl->tpl_vars['get']->value['action'])]['tri'] !== null )) && $_SESSION[$_smarty_tpl->tpl_vars['get']->value['app']][($_smarty_tpl->tpl_vars['get']->value['module']).($_smarty_tpl->tpl_vars['get']->value['action'])]['tri'] == 1) {?>selected<?php }?>>Prix croissant</option>
                            <option value="2" <?php if ((($_SESSION[$_smarty_tpl->tpl_vars['get']->value['app']][($_smarty_tpl->tpl_vars['get']->value['module']).($_smarty_tpl->tpl_vars['get']->value['action'])]['tri'] !== null )) && $_SESSION[$_smarty_tpl->tpl_vars['get']->value['app']][($_smarty_tpl->tpl_vars['get']->value['module']).($_smarty_tpl->tpl_vars['get']->value['action'])]['tri'] == 2) {?>selected<?php }?>>Prix d&eacute;croissant</option>
                        </select>
                    </div>
                </div>
            </div>
...
" class="text-secondary content-font--bold"><?php echo $_smarty_tpl->tpl_vars['bien']->value->titre_cut;?>
 ...
 <?php if (!empty($_smarty_tpl->tpl_vars['bien']->value->nb_pieces)) {?>, <?php echo $_smarty_tpl->tpl_vars['bien']->value->nb_pieces;?>
 pièce(s)<?php }?></div>
...
<?php $_smarty_tpl->_subTemplateRender(((string)$_smarty_tpl->tpl_vars['template']->value)."/common/_contact.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0, true);
?>
