...
class Smarty extends Smarty_Internal_TemplateBase
{
    ...
    */
     ...
     * @var string[]
     */
    protected $obsoleteProperties = ['resource_caching', 'template_resource_caching', 'direct_access_security',
     ...
     * @var string[]
     */
    protected $accessMap = ['template_dir'      => 'TemplateDir', 'config_dir' => 'ConfigDir',
    ...
    public function _realpath($path, $realpath = null)
    {
        ...
        $path = str_replace([$nds[DIRECTORY_SEPARATOR], $sepDotsep], DIRECTORY_SEPARATOR, $path);
        ...
        $path = str_replace([$sepDotsep, $sepSep], DIRECTORY_SEPARATOR, $path);
